...
export const portfolioReducer = createReducer(initialState, (builder) => {
    ...
    builder.addCase(ADD_NEW_EDUCATION, (state,action) => {
        state.newlyAddedEducation.push(action.payload);
    });
});
